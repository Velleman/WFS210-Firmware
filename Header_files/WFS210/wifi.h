...
#define SET_WIFI_AP_SSID			"set apmode ssid "
...
#define SET_WIFI_IP_ADDRESS			"set ip address 192.168.1.1\r\n"
#define SET_WIFI_NETMASK			"set ip netmask 255.255.255.0\r\n"
#define SET_WIFI_GATEWAY			"set ip gateway 192.168.1.1\r\n"
...
#define SM_CUSTOM_IP            58
#define SM_CUSTOM_GATEWAY           59
#define SM_CUSTOM_SETTINGS_SAVE				60
#define SM_CUSTOM_SETTINGS_RESET			61
#define SM_CUSTOM_SETTINGS_RESET_READY		62

// state machine enter sleep mode
#define SM_START_SLEEP						63
#define SM_START_SLEEP_CMD_MODE				64
#define SM_SLEEP_CMD_MODE					65
#define SM_ENTER_SLEEP						66
#define SM_SLEEP							67
